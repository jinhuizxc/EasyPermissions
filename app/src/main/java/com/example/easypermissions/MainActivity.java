...
//        }
    ...
    @AfterPermissionGranted(Constant.Permission.REQUEST_CODE_STORE_LOCATION_AUDIO)
    private void methodRequiresTwoPermission() {
        //String[] perms = {Manifest.permission.CAMERA, Manifest.permission.CHANGE_WIFI_STATE};
//        String[] perms = {Manifest.permission.CAMERA, Manifest.permission.CALL_PHONE};  // 电话，相机权限
        if (hasPermission()) {
            // Already have permission, do the thing
            // ...
//            Toast.makeText(this, R.string.hasPermissions, Toast.LENGTH_SHORT)
//                    .show();
            Toast.makeText(this, "权限被授予成功, doSomething!", Toast.LENGTH_SHORT)
                    .show();
            ...
            EasyPermissions.requestPermissions(this, getString(R.string.camera_and_wifi_rationale),
                    Constant.Permission.REQUEST_CODE_STORE_LOCATION_AUDIO, Constant.Permission.PERMS_STORE_LOCATION_AUDIO);
        }
    }

    private boolean hasPermission() {
        return EasyPermissions.hasPermissions(this, Constant.Permission.PERMS_STORE_LOCATION_AUDIO);
    }
